  ...
  return (
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="">
           <i class="fa fa-university" aria-hidden="true"></i> Funds
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Add money
          </a>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
         <h4 className=""><i class="fa fa-check-circle-o" aria-hidden="true"></i>Coin
        </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Portfolio
          </a>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="">
            <i class="fa fa-address-card" aria-hidden="true"></i> Console
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Mutual funds
          </a>
